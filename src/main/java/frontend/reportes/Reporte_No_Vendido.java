 ...
 * @author lguilln
 */
public class Reporte_No_Vendido extends javax.swing.JInternalFrame {

    /**
     * Creates new form Registrar_Producto
     */
    public Reporte_No_Vendido() {
        initComponents();
    ...
    private void initComponents() {
        ...
        generarReporte9 = new javax.swing.JButton();
        tiempoTienda = new javax.swing.JComboBox<>();
        exportarReporte9 = new javax.swing.JButton();

        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
        setTitle("Lista de Productos Jamás Vendidos");
        ...
        generarReporte9.setBackground(new java.awt.Color(102, 255, 0));
        generarReporte9.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        generarReporte9.setText("Generar");
        generarReporte9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                generarReporte9ActionPerformed(evt);
            }
        });
        ...
        exportarReporte9.setBackground(new java.awt.Color(102, 255, 0));
        exportarReporte9.setFont(new java.awt.Font("Arial Black", 1, 18)); // NOI18N
        exportarReporte9.setText("Exportar");
        exportarReporte9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                exportarReporte9ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(66, 66, 66)
                .addComponent(generarReporte9)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(exportarReporte9)
                .addGap(67, 67, 67))
        );
    ...
    private void generarReporte9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generarReporte9ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_generarReporte9ActionPerformed
    ...
    private void exportarReporte9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportarReporte9ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_exportarReporte9ActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton exportarReporte9;
    private javax.swing.JButton generarReporte9;
